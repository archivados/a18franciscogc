 ...
 * AUTHOR MENTION:
 * -----------------------------------------------------------------------------------------------
 *     This is a literal copy of the OCA kanban_gauge to which I have added a
 * constant to define the initial value of the color progression that will be
 * inverse to the normal progression, that is, the lower the progression, the
 * more color of the bar it will get closer to the initial value and the bigger 
 * it is, the closer it will get to the red color (default).
 * 
 * Original code:
 * <https://github.com/OCA/OCB/blob/12.0/addons/web_kanban_gauge/static/src/js/kanban_gauge.js>
 * 
 * -----------------------------------------------------------------------------------------------
 * The contributors at the time of copying this code are:
 * -----------------------------------------------------------------------------------------------
 * Thibault Delavallée: https://github.com/tde-banana-odoo
 * Turkesh Patel:       https://github.com/tpa-odoo
 * Géry Debongnie:      https://github.com/ged-odoo
 * xmo-odoo:            https://github.com/xmo-odoo
 * Christophe Matthieu: https://github.com/Gorash
 * De Paoli Quentin:    https://github.com/qdp-odoo
 * Olivier Dony:        https://github.com/odony
 * aab-odoo:            https://github.com/aab-odoo
 * -----------------------------------------------------------------------------------------------
*/
odoo.define('xestionsat_kanban_gauge.widget', function (require) {
"use strict";
...
// Modification on the original code
const START_HUE = 120;
...
var InvertedGaugeWidget = AbstractField.extend({
    ...
    _render: function () {
        ...
        var foreground = svg.append("path")
            ...
            // Modification on the original code
            .style("fill", "hsl(" + START_HUE + ", 80%, 50%)")
            .attr("d", arc);

        var ratio = max_value ? value/max_value : 0;
        // Modification on the original code
        var hue = START_HUE - Math.round(ratio*120);
